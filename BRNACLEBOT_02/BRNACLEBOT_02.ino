...
void setup() {
  ...
  display.getTextBounds("BOBOBOY DESTROYER", 0, 0, &x, &y, &w, &h); //untuk mendapatkan jumlah piksel dalam lebar dan tinggi untuk tulisan WELCOME
  ...
  display.print("BOBOBOY DESTROYER");
  display.display();
  delay(500);
  ...
  display.getTextBounds("Raja PH", 0, 0, &x, &y, &w, &h); //untuk mendapatkan jumlah piksel dalam lebar dan tinggi untuk tulisan WELCOME
  panjang = (SCREEN_WIDTH - w) / 2; // Untuk menentukan penempatan piksel pertama
  lebar = (SCREEN_HEIGHT - h) / 2;
  display.setCursor(panjang, 20);     // kursor diletakkan pada rata tengah kolom 0
  display.print("RAJA PH");
  display.display();

  //sekarang kita buat tulisan di bagian bawah layar
  display.getTextBounds("AIDIL", 0, 0, &x, &y, &w, &h); //untuk mendapatkan jumlah piksel dalam lebar dan tinggi untuk tulisan WELCOME
  panjang = (SCREEN_WIDTH - w) / 2; // Untuk menentukan penempatan piksel pertama
  ...
  //sekarang kita buat tulisan di bagian bawah layar
  display.getTextBounds("WICKY REO", 0, 0, &x, &y, &w, &h); //untuk mendapatkan jumlah piksel dalam lebar dan tinggi untuk tulisan WELCOME
  panjang = (SCREEN_WIDTH - w) / 2; // Untuk menentukan penempatan piksel pertama
  lebar = SCREEN_HEIGHT - h;
  display.setCursor(panjang, 50);     // kursor diletakkan pada rata tengah kolom 0
  display.print("WICKY REO");
  display.display();
